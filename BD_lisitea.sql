...
CREATE TABLE `tbl_contenido_contenido` (
  ...
  CONSTRAINT `PFK_id_contenido_central3` FOREIGN KEY (`PFK_id_contenido_central`) REFERENCES `tbl_con_central` (`pk_id_con_central`) ON DELETE CASCADE ON UPDATE CASCADE,
